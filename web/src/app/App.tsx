...
function AuthenticatedShell() {
  ...
  return <PlayerProvider persistenceUserId={auth.user?.kitsuUserId} preferencesReady={Boolean(library)} preferenceSnapshot={preferenceSnapshot} animeTitleCatalog={library?.animeById}><ResponsiveShell /></PlayerProvider>
}
