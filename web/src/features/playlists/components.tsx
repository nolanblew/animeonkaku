    ...
    <form className="playlist-editor" onSubmit={submit} noValidate>
      ...
      {showDetails && <div className="playlist-editor__step-panel">
        ...
        <div className="playlist-editor__grid">
          ...
          <label className="playlist-check"><input type="checkbox" checked={values.overrideUserPreference} onChange={(event) => setValue('overrideUserPreference', event.target.checked)} /><span>Require selected version (skip unavailable tracks)</span></label>
        </div>
      </div>}
