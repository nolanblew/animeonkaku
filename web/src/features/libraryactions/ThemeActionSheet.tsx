...
function ActionButton({ icon, label, onClick }: { icon: React.ReactNode; label: string; onClick?: () => void }) {
  return <button className="library-actions__primary-button" type="button" onClick={onClick} disabled={!onClick}>{icon}<span>{label}</span></button>
}
