...
export interface StoredMusicBatch { id: string; requestId: string; index: number; state: MusicBatchState; body: AmfJobCreate; idempotencyKey: string; amfJobId: string | null; warningCount: number; }
